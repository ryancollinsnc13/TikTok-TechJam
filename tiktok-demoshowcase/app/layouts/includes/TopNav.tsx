...
export default function TopNav(){
    ...
    return(
        <>
        <div id="TopNav" className="fixed bg-white z-30 items-center w-full border-b h-[60px]">
            <div className={`flex justify-between items-center gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>
                <Link href="/">
                            ...
                            <div className="p-1">
                                ...
                                >
                                    <div className="flex items-center">
                                            ...
                                            <div className="truncate ml-2">Ryan Collins</div>
                                    </div>
                                </Link>
                            </div>
                    </div>
